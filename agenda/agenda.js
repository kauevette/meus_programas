...
const btn_novo = document.querySelector("#btn-novo");
const btn_pesquisar = document.querySelector("#btn-pesquisar");
const btn_gestao = document.querySelector("#btn-gestao");
